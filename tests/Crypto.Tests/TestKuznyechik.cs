...
namespace KuznyechikTests
{
    ...
    public class KuznyechikTests
    {
        ...
        [TestMethod]
        public void TestKuznyechik_S_inv()
        {
            string[] output =
            [
                "ffeeddccbbaa99881122334455667700",
        ...
        [TestMethod]
        public void TestKuznyechik_R_inv()
        {
            string[] output =
            [
                "00000000000000000000000000000100",
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                Assert.AreEqual(output[i], ToHex(sb));
            }
        }
        [TestMethod]
        public void TestKuznyechik_L()
        {
            string[] input =
            [
                "64a59400000000000000000000000000",
        ...
        [TestMethod]
        public void TestKuznyechik_L_inv()
        {
            string[] output =
            [
                "64a59400000000000000000000000000",
        ...
        [TestMethod]
        public void TestKuznyechik_ExpandKey()
        {
