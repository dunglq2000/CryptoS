namespace Crypto.Tests
{
    ...
    public class TestMagma
    {
        ...
        [TestMethod]
        public void TestMagma_T()
        {
            string[] input = ["fdb97531", "2a196f34", "ebd9f03a", "b039bb3d"];
            string[] output =
                [
                    "2a196f34",
                    "ebd9f03a",
        ...
        public void TestMagma_G()
        {
            ...
            string[] output = ["fdcbc20c", "7e791a4b", "c76549ec", "9791c849"];
            for (int i = 0; i < input.Length; i++)
            {
        ...
        public void TestMagma_Round()
        {
            ...
            string[] output =
                [
                    "7654321028da3b14", "28da3b14b14337a5",
                    "b14337a5633a7c68", "633a7c68ea89c02c",
                    "ea89c02c11fe726d", "11fe726dad0310a4",
                    "ad0310a437d97f25", "37d97f2546324615",
                    "46324615ce995f2a", "ce995f2a93c1f449",
                    "93c1f4494811c7ad", "4811c7adc4b3edca",
                    "c4b3edca44ca5ce1", "44ca5ce1fef51b68",
                    "fef51b682098cd86", "2098cd864f15b0bb",
                    "4f15b0bbe32805bc", "e32805bce7116722",
                    "e711672289cadf21", "89cadf21bac8444d",
                    "bac8444d11263a21", "11263a21625434c3",
                    "625434c38025c0a5", "8025c0a5b0d66514",
                    "b0d6651447b1d5f4", "47b1d5f4c78e6d50",
                    "c78e6d5080251e99", "80251e992b96eca6",
                    "2b96eca605ef4401", "05ef4401239a4577",
                    "239a4577c2d8ca3d", "4ee901e5c2d8ca3d"
                ];
            for (int i = 0; i < 24; i++)
            {
